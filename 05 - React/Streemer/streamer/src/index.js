...
import { TrendingList, CustomNavbar, Footer, Movies, Rate, TVShows, Seasons, Episodes, Search, People } from './Components'; // Custom import for components
...
root.render(
  <BrowserRouter>
    ...
    <Routes>
      ...
      <Route path='/view/person/:personID' element={<People/>} />
